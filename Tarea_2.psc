...
Funcion numero_neutro_positivo_negativo()
...
Funcion CalcularGananciaUva()
	...
	//Entrada:tu(leer),tu(leer),k(leer),pi(leer),g(leer),pf(leer)
...
Funcion pago_companñia_pago_porestudiante()
...
Funcion promocion_supermercado()
...
Funcion calcularlospreciosde_venta()
...
Funcion imiteDetarjeta_deCredito()
...
//FinSi
//salida:contador+1
Funcion precentarnumeros_pares()
	contador <- 0
...
Funcion Calificaciones_Nalumno()
...
Funcion SerieNcantidad_deViajes()
...
funcion Serie_Numerosdistintode_cero()
...
funcion Calcular_posit_ver_sies_multiple_tres()
...
Algoritmo ejercicios
	...
	Mostrar_mesDelAño()
	Estatura_Promedio()
	precentarnumeros_pares()
	suma_suseciva()
	promedio_edad()
	Total_horas()
	Ventas_global()
	Calificaciones_Nalumno()
	SueldoPORcategoria()
	SerieNcantidad_deViajes()
	Serie_Numerosdistintode_cero()
	Calcular_posit_ver_sies_multiple_tres()
